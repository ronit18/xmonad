...
myStartupHook = do
  ...
  spawnOnce "sh ~/.config/xmonad/autostart.sh"
...
gsCategories =
  [ ("Utilities1",      "xdotool key super+alt+1")
  , ("Utilities2",  "xdotool key super+alt+2")
  , ("Utilities3",   "xdotool key super+alt+3")
  , ("Utilities4", "xdotool key super+alt+4")
  , ("Utilities5",     "xdotool key super+alt+5")
  , ("Utilities6",   "xdotool key super+alt+6")
  , ("Utilities7",     "xdotool key super+alt+7")
  , ("Utilities8",  "xdotool key super+alt+8")
  ]
...
myKeys c =
  ...
  , ("M-x", addName "Quit XMonad"              $ spawn "archlinux-logout")
  , ("M-S-q", addName "Kill focused window"    $ kill1)
  , ("M-q", addName "Kill focused window"      $ kill1)
  , ("M-S-<Return>", addName "file manager"      $ spawn "thunar")
  , ("M-S-d", addName "Run prompt"             $ spawn "dmenu_run")]
  ...
  [ ("M1-<Return>", addName "Select favorite apps" $ spawnSelected'
       $ gsUtilities1 ++ gsUtilities2 ++ gsUtilities3 ++ gsUtilities4 ++ gsUtilities5 ++ gsUtilities6 ++ gsUtilities7 ++ gsUtilities8)
  ]
